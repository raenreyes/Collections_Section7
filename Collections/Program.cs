            ...
            for (int i = 0; i < board.GetLength(0); i++)
            {
                for (int j = 0; j < board.GetLength(1); j++)
                {
                    ...
                    if (j == 0 && board[i, j] == "X")
                    {
                        ...
                        {
                            Console.WriteLine("Found Vertical X at row " + j);
                    ...
                    else if (j == 0 && board[i, j] == "O")
                    {
                        ...
                        {
                            Console.WriteLine("Found Vertical O at row " + j);
                    ...
                    if (i == 0 && board[i, j] == "X")
                    {
                        ...
                        {
                            Console.WriteLine("Found Horizontal X at row " + i);
                    ...
                    else if (i == 0 && board[i, j] == "O")
                    {
                        ...
                        {
                            Console.WriteLine("Found Horizontal O at row " + i);
                    ...
                    if (i == j && board[i, j] == "X")
                    {
                        ...
                        if (topLeftX == 3)
                        {
                            Console.WriteLine("Found top left to bottom right diagonal with X");
                        }
                    }
                    else if (i == j && board[i, j] == "O")
                    {
                        ...
                        if (topLeftO == 3)
                        {
                            Console.WriteLine("Found top left to bottom right diagonal with O");
                        }
                    }
                    if (i + j == board.GetLength(1) - 1 && board[i, j] == "X")
                    {
                        ...
                        if (topRightX == 3)
                        {
                            Console.WriteLine("Found top right to bottom left diagonal with X");
                        }
                    }
                    ...
                    else if (i + j == board.GetLength(1) - 1 && board[i, j] == "O")
                    {
                        ...
                        if (topRightO == 3)
                        {
                            Console.WriteLine("Found top right to bottom left diagonal with O");
                        }
                    }
                }
